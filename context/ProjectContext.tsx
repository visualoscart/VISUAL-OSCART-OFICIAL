...
export const ProjectProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <ProjectContext.Provider value={{
      projects, tasks, currentUser, usersDB, receipts, expenses, expenseTracking, campaigns, performances, notifications, baseSalaries, taskRates, financeSettings, studioLogo, dashboardBanner, dashboardBannerTitle, dashboardBannerSubtitle, loginBackground, loginTitle, loginSubtitle, isSyncing, toast, showToast, messages,
      login, logout,
      ...
      updateProject: async (id, d) => { 
        ...
        if (d.typography !== undefined) { payload.typography = d.typography; }
