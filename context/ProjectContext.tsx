  ...
  return (
    <ProjectContext.Provider value={{
      ...
      sendReceiptToUser: async (r) => {
        const payload = { user_id: r.userId, user_name: r.userName, month: r.month, year: Number(r.year), base_salary: Number(r.baseSalary), ninja_bonus: Number(r.ninjaBonus), master_bonus: Number(r.master_bonus), total: Number(r.total), date: r.date, receipt_number: r.receiptNumber };
