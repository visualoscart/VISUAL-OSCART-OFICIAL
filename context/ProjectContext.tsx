...
import { Project, TextAsset, MediaAsset, Task, UserProfile, Receipt, ChatMessage, Expense, Campaign } from '../types';
...
export const ProjectProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <ProjectContext.Provider value={{
      projects, tasks, currentUser, usersDB, receipts, expenses, campaigns, notifications, baseSalaries, taskRates, financeSettings, studioLogo, dashboardBanner, dashboardBannerTitle, dashboardBannerSubtitle, loginBackground, loginTitle, loginSubtitle, isSyncing, toast, showToast, messages,
      login, logout,
