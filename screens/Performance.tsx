...
const Performance: React.FC = () => {
 ...
 const code = (selectedProject.typography?.brandCode || selectedProject.name).toUpperCase();
 pdf.save(`${selectedMonth.toUpperCase()} ${selectedYear} - ${code} RENDIMIENTO.pdf`);
 } catch (err) {
 console.error(err);
 ...
 className="w-12 h-12 rounded-2xl bg-white/5 border border-white/5 border-t-white/15/10 flex items-center justify-center text-slate-500 hover:text-white hover:bg-white/10 transition-all font-black group shrink-0"
 >
 ...
 className="p-2 rounded-xl bg-white/5 hover:bg-white/10 text-slate-500 hover:text-white transition-all mr-2"
 >
 ...
 className="group relative glass-panel p-8 rounded-[2.5rem] border border-white/5 border-t-white/15/5 hover:border-primary/30 transition-all text-left overflow-hidden hover:shadow-2xl hover:shadow-primary/10"
 >
 ...
 <div className="w-16 h-16 rounded-3xl bg-background-dark border border-white/5 border-t-white/15/10 flex items-center justify-center overflow-hidden shadow-inner shadow-black/50">
 {p.logoUrl ? (
 ...
 <div>
 <h3 className="text-xl font-black text-white uppercase tracking-tighter leading-tight group-hover:text-primary transition-colors">{p.name}</h3>
 ...
 <span className="text-sm font-black text-white uppercase tracking-tighter">{report.month}</span>
 ...
 <h2 className="text-xl font-black uppercase tracking-tighter text-white">Gestionando: {selectedMonth} {selectedYear}</h2>
 </div>
 <button 
 onClick={() => setIsEditing(false)}
 className="px-6 py-2.5 rounded-xl bg-white/5 border border-white/5 border-t-white/15/10 text-[10px] font-black uppercase tracking-widest hover:bg-rose-500/20 hover:border-rose-500/30 transition-all text-slate-300"
 >
 Cerrar Periodo
 </button>
 </div>
 ...
 className="bg-white/5 border border-white/5 border-t-white/15/10 rounded-xl p-3 text-white text-xs font-bold transition-all"
 >
 ...
 : 'bg-white/5 border-transparent text-slate-300 grayscale opacity-50'
 }`}
 >
 ...
 <div className="col-span-3 text-[10px] font-black text-white uppercase">{ag.age}</div>
 ...
 className="w-full bg-background-dark/50 border border-white/5 border-t-white/15/10 rounded-lg p-2 text-white text-[10px] font-bold text-center"
 />
 </div>
 <div className="col-span-4">
 <input 
 ...
 className="w-full bg-background-dark/50 border border-white/5 border-t-white/15/10 rounded-lg p-2 text-white text-[10px] font-bold"
 />
 </div>
 ...
 return (
 <div key={platform} className="p-8 rounded-[2.5rem] bg-[#0f172a]/40 border border-white/5 border-t-white/15/5 space-y-8 hover:bg-[#0f172a]/60 transition-all group shadow-2xl relative overflow-hidden">
 <div className="absolute top-0 right-0 p-6 opacity-[0.02] group-hover:opacity-[0.05] transition-opacity">
 <pInfo.icon className="w-20 h-20"/>
 </div>
 <div className="flex items-center gap-4 relative z-10">
 <div className="p-3.5 rounded-[1.2rem] bg-background-dark border border-white/5 border-t-white/15/10 group-hover:border-primary/40 transition-all shadow-inner">
 <pInfo.icon className="w-6 h-6"style={{ color: pInfo.color }} />
 </div>
 <span className="text-base font-black text-white uppercase tracking-tighter">{platform}</span>
 </div>
 ...
 <input type="number"value={metrics[platform].followers || ''} onChange={(e) => handleMetricChange(platform, 'followers', e.target.value)} className="w-full bg-background-dark/80 border border-white/5 border-t-white/15/10 rounded-2xl p-4 text-white text-base font-bold focus:outline-none focus:border-primary/50 transition-all shadow-inner"/>
 {fComp && (
 ...
 <input type="number"value={metrics[platform].totalFollowers || ''} onChange={(e) => handleMetricChange(platform, 'totalFollowers', e.target.value)} className="w-full bg-background-dark/80 border border-white/5 border-t-white/15/10 rounded-2xl p-4 text-white text-base font-bold focus:outline-none focus:border-primary/50 transition-all shadow-inner"/>
 </div>
 </div>
 <div className="space-y-3">
 <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] px-1">Alcance Mensual</label>
 <div className="space-y-2">
 <input type="number"value={metrics[platform].reach || ''} onChange={(e) => handleMetricChange(platform, 'reach', e.target.value)} className="w-full bg-background-dark/80 border border-white/5 border-t-white/15/10 rounded-2xl p-4 text-white text-base font-bold focus:outline-none focus:border-primary/50 transition-all shadow-inner"/>
 {rComp && (
 ...
 <input type="number"value={metrics[platform].interactions || ''} onChange={(e) => handleMetricChange(platform, 'interactions', e.target.value)} className="w-full bg-background-dark/80 border border-white/5 border-t-white/15/10 rounded-2xl p-4 text-white text-base font-bold focus:outline-none focus:border-primary/50 transition-all shadow-inner"/>
 </div>
 <div className="space-y-3">
 <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] px-1 text-right">Leads</label>
 <input type="number"value={metrics[platform].leads || ''} onChange={(e) => handleMetricChange(platform, 'leads', e.target.value)} className="w-full bg-background-dark/80 border border-white/5 border-t-white/15/10 rounded-2xl p-4 text-white text-base font-bold text-right focus:outline-none focus:border-primary/50 transition-all shadow-inner"/>
 </div>
 </div>
 <div className="space-y-3">
 <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] px-1">Engagement Rate (%)</label>
 <input type="number"step="0.1"value={metrics[platform].engagement || ''} onChange={(e) => handleMetricChange(platform, 'engagement', e.target.value)} className="w-full bg-background-dark/80 border border-white/5 border-t-white/15/10 rounded-2xl p-4 text-primary text-base font-black focus:outline-none focus:border-primary/50 transition-all shadow-inner"/>
 </div>
 </div>
 </div>
 );
 ...
 {[0, 1, 2].map((idx) => (
 <div key={idx} className="p-6 rounded-[2rem] bg-white/[0.02] border border-white/5 border-t-white/15/5 space-y-5 group relative">
 <div className="absolute -top-2 -left-2 w-8 h-8 rounded-xl bg-primary flex items-center justify-center text-white font-black text-xs shadow-lg shadow-primary/20 z-10">
 #{idx + 1}
 </div>
 
 <div className="space-y-3">
 <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.15em] px-1">Miniatura (4:5)</label>
 <div className="relative aspect-[4/5] rounded-[2rem] bg-background-dark border border-white/5 border-t-white/15/5 overflow-hidden group/thumb shadow-inner">
 ...
 <div className="w-full h-full flex flex-col items-center justify-center gap-3 text-slate-300 group-hover:text-primary transition-colors">
 <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center border border-white/5 border-t-white/15/5">
 ...
 className="w-full bg-white/5 border border-white/5 border-t-white/15/10 rounded-[2rem] p-8 text-white text-base min-h-[200px] focus:outline-none focus:border-primary/50 transition-all font-medium leading-[1.8]"
 />
 </section>
 ...
 <input type="text"value={work.description} onChange={(e) => handleExtraWorkChange(idx, 'description', e.target.value)} className="w-full bg-white/5 border border-white/5 border-t-white/15/10 rounded-xl p-3 text-white text-[11px] font-bold focus:outline-none focus:border-primary/50 transition-all text-xs"/>
 </div>
 <div className="col-span-4">
 <input type="date"value={work.date} onChange={(e) => handleExtraWorkChange(idx, 'date', e.target.value)} className="w-full bg-white/5 border border-white/5 border-t-white/15/10 rounded-xl p-3 text-white text-[11px] font-bold focus:outline-none focus:border-primary/50 transition-all text-xs"/>
 </div>
 </div>
 <button onClick={() => handleRemoveExtraWork(idx)} className="p-3 text-slate-300 hover:text-rose-500 transition-all">
 ...
 <p className="text-sm font-black text-white">{prevMonthReport.metrics.reduce((acc, m) => acc + (m.reach || 0), 0).toLocaleString()}</p>
 </div>
 <div className="space-y-1">
 <p className="text-[9px] font-black text-slate-500 uppercase">Interac. Prev.</p>
 <p className="text-sm font-black text-white">{prevMonthReport.metrics.reduce((acc, m) => acc + (m.interactions || 0), 0).toLocaleString()}</p>
 </div>
 </div>
 <div className="pt-4 border-t border-indigo-500/10">
 <p className="text-[9px] font-bold text-indigo-300/50 uppercase tracking-widest">Comparando con {prevMonthReport.month} {prevMonthReport.year}</p>
 </div>
 </section>
 )}
 ...
 <div className="space-y-6">
 <div className="p-8 rounded-[2rem] bg-background-dark/50 border border-white/5 border-t-white/15/5 relative overflow-hidden group shadow-inner">
 ...
 <span className="text-5xl font-black text-white tracking-tighter">{autoData.posts}</span>
 <span className="text-[11px] font-bold text-primary uppercase">Contenidos</span>
 </div>
 </div>
 <div className="p-8 rounded-[2rem] bg-background-dark/50 border border-white/5 border-t-white/15/5 relative overflow-hidden group shadow-inner">
 ...
 <div className="flex items-baseline gap-2">
 <span className="text-5xl font-black text-white tracking-tighter">{autoData.productions}</span>
 <span className="text-[11px] font-bold text-slate-500 uppercase">Jornadas</span>
 </div>
 </div>
 </div>
 ...
 <div key={i} className="flex flex-col p-3 rounded-xl bg-white/5 border border-white/5 border-t-white/15/5 gap-1">
 <div className="flex justify-between items-center">
 <span className="text-[10px] font-bold text-primary uppercase">{log.title}</span>
 <span className="text-[8px] font-mono text-slate-500">{log.date ? format(new Date(log.date + 'T12:00:00'), 'dd MMM') : 'S/F'}</span>
 </div>
 </div>
 )) : (
 <p className="text-[9px] font-bold text-slate-300 uppercase py-4 text-center">Sin actividad registrada este mes</p>
 )}
 </div>
 </div>

 <div className="pt-8 border-t border-white/5 space-y-4">
 <button onClick={handleSaveReport} className="w-full py-5 rounded-[1.5rem] bg-white/5 border border-white/5 border-t-white/15/10 text-white font-black text-xs uppercase tracking-[0.2em] hover:bg-white/10 transition-all flex items-center justify-center gap-3">
 ...
 >
 <div className="w-20 h-20 rounded-[2.5rem] bg-white/5 flex items-center justify-center border border-white/5 border-t-white/15/10 opacity-30 shadow-2xl">
 <LayoutDashboard className="w-10 h-10 text-primary"/>
 </div>
 <div className="space-y-2">
 <h4 className="text-lg font-black text-white uppercase tracking-tighter">Bóveda Seleccionada: {selectedProject?.name}</h4>
 ...
 return (
 <div className="bg-[#202020] font-sans text-white">
 ...
 <img src={selectedProject.logoUrl} crossOrigin="anonymous"className="h-24 w-auto object-contain rounded-2xl" alt=""/>
 )}
 <div className="space-y-3">
 ...
 {/* Card 1: Engagement */}
 <div className="bg-gradient-to-br from-[#363636] to-[#2a2a2a] shadow-xl shadow-black/40 p-8 pt-6 space-y-6 rounded-[2rem] flex flex-col justify-between border border-white/5 border-t-white/15 relative overflow-hidden">
 ...
 <p className="text-[10px] font-black text-white uppercase leading-tight"><span className="mr-1" style={{ color: selectedProject?.brandColors?.[0] || '#8c2bee' }}>#{i + 1}</span>{post.title || 'Post sin título'}</p>
 <div className="grid grid-cols-1 gap-1 pt-2 border-t border-white">
 <div className="flex justify-between items-center">
 ...
 {PLATFORMS.find(p => p.id === platform)?.icon && React.createElement(PLATFORMS.find(p => p.id === platform)!.icon, { className:"w-5 h-5 text-white"})}
 </div>
 <span className="font-black text-white text-base uppercase tracking-tight">{platform}</span>
 </td>
 <td className="p-6 text-right">
 <p className="text-lg font-black text-white leading-none">+{metrics[platform]?.followers?.toLocaleString() || '0'}</p>
 {fComp && (
 ...
 <td className="p-6 text-right font-black text-slate-200 text-lg leading-none">{metrics[platform]?.totalFollowers?.toLocaleString() || '-'}</td>
 <td className="p-6 text-right">
 <p className="font-black text-slate-200 text-lg leading-none">{metrics[platform]?.reach?.toLocaleString() || '0'}</p>
 {rComp && (
 ...
 <td className="p-6 text-right">
 <p className="font-black text-slate-200 text-lg">{metrics[platform]?.interactions?.toLocaleString() || '0'}</p>
 {iComp && (
 <p className={`text-[11px] font-black uppercase ${iComp.increased ? 'text-emerald-400' : 'text-rose-400'}`}>
 {iComp.increased ? '↑' : '↓'} {iComp.percent}% {MONTHS[(MONTHS.indexOf(selectedMonth) - 1 + 12) % 12]}
 </p>
 )}
 </td>
 <td className="p-6 text-right">
 <p className="text-2xl font-black text-white tracking-tighter">{metrics[platform]?.engagement || '0'}%</p>
 </td>
 </tr>
 );
 })}
 ...
 <div className="bg-gradient-to-br from-[#363636] to-[#2a2a2a] shadow-xl shadow-black/40 p-5 rounded-2xl border border-white/5 border-t-white/15">
 ...
 const pieData = [
 { name: 'Hombres', value: totalMale, color: selectedProject?.brandColors?.[0] || '#8c2bee' },
 { name: 'Mujeres', value: totalFemale, color: selectedProject?.brandColors?.[1] || '#f97316' }
 ];
 return (
 ...
 <div className="bg-gradient-to-br from-[#363636] to-[#2a2a2a] shadow-xl shadow-black/40 p-8 border border-white/5 border-t-white/15 rounded-[2rem] flex flex-col items-center">
 ...
 <div className="w-2 h-2 rounded-full" style={{ backgroundColor: selectedProject?.brandColors?.[0] || '#8c2bee' }}/>
 ...
 <div className="space-y-1">
 <div className="flex items-center gap-2">
 <div className="w-2 h-2 rounded-full" style={{ backgroundColor: selectedProject?.brandColors?.[1] || '#f97316' }}/>
 ...
 <div className="bg-gradient-to-br from-[#363636] to-[#2a2a2a] shadow-xl shadow-black/40 p-8 border border-white/5 border-t-white/15 rounded-2xl">
 ...
 <div style={{ width: `${city.value}%`, backgroundColor: selectedProject?.brandColors?.[0] || "#8c2bee" }} className="h-full rounded-full"/>
 </div>
 </div>
 ))}
 </div>
 ...
 <div className="grid grid-cols-2 gap-10">
 <div className="bg-gradient-to-br from-[#363636] to-[#2a2a2a] shadow-xl shadow-black/40 p-4 flex flex-col justify-between h-[85px] relative overflow-hidden rounded-xl border border-white/5 border-t-white/15 shadow-sm">
 ...
 <div className="bg-gradient-to-br from-[#363636] to-[#2a2a2a] shadow-xl shadow-black/40 p-4 border border-white/5 border-t-white/15 flex flex-col justify-between h-[85px] relative overflow-hidden rounded-xl">
 ...
 <thead className="bg-gradient-to-br from-[#363636] to-[#2a2a2a] shadow-xl shadow-black/40 border-b border-white">
