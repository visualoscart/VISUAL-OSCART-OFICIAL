                    ...
                    <div className="lg:col-span-8 glass-panel p-8 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] space-y-8 border border-white/5 overflow-hidden shadow-xl">
                        <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-[8px] font-black text-slate-500 uppercase tracking-widest mt-1">Sincronización mensual: {["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"][selectedPeriod.month]} {selectedPeriod.year} (1 al {new Date(selectedPeriod.year, selectedPeriod.month + 1, 0).getDate()})</p>
                            </div>
                            <div className="flex items-center gap-4">
