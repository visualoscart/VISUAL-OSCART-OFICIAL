...
const ValidationFlow: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    brandName: '', niche: '', brandCode: '', brief: '', clientName: '', logoUrl: '', 
            ...
            <div className="space-y-16 animate-in fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-8">
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest px-1 italic">Código de Marca (Uppercase)</label>
                    <input className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white text-xs font-black uppercase outline-none focus:border-primary transition-all tracking-[0.2em]" value={formData.brandCode} onChange={e => setFormData({...formData, brandCode: e.target.value.toUpperCase()})} placeholder="Ej: MARCAXX" />
                  </div>
                  <div className="space-y-2">
