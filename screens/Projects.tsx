                ...
                >
                  <div className="flex justify-between items-start mb-8">
                    ...
                    <div className="relative group/logo">
                      ...
                      {project.brandCode && (
                        <div className="absolute -bottom-2 -right-2 px-2 py-0.5 bg-primary text-[7px] font-black italic rounded-md shadow-lg border border-white/10 z-10 uppercase tracking-tighter">
                          {project.brandCode}
                        </div>
                      )}
                    </div>
