        ...
        <div className="flex-1 p-10 lg:p-16 flex flex-col justify-center bg-white/[0.01]">
          <div className="max-w-[320px] mx-auto w-full">
            <div className="mb-10 text-center md:text-left">
              ...
              <p className="text-slate-500 text-xs font-black uppercase tracking-widest opacity-60">Sincronización de Identidad</p>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleLogin}>
              <div className="space-y-1.5">
                <label className="text-xs font-black text-slate-500 uppercase tracking-widest px-1">Identificador de Red</label>
                <input 
                  required 
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-black text-slate-500 uppercase tracking-widest px-1">Clave de Bóveda</label>
                <input 
                  required 
                  className="w-full rounded-2xl p-4 text-xs text-white outline-none focus:border-primary transition-all bg-white/[0.02] border border-white/5" 
                  type="password" 
